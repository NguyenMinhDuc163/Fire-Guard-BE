...
exports.saveSensorData = async (req, res) => {
    ...
    if (error) {
        ...
        return res.status(200).json(createResponse('fail', error.details[0].message, 400, null, error.details[0].message));
    }
    ...
    try {
        ...
        res.status(200).json(createResponse('fail', 'Lỗi khi lưu trữ dữ liệu.', 500, null, err.message));
    }
};
